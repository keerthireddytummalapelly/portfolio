...
const Intro = () => {
  ...
  return (
    <div className=" flex flex-row items-center justify-between h-screen text-black px-4 sm:px-6 lg:px-8">
      <div className="w-2/3 text-left">
      <h1 className="text-3xl lg:text-5xl font-thin mb-4 lg:mt-0 mt-14 text-white">
  Hello, I'm <br />
  <span className="bg-gradient-to-r font-bold from-[#a855f7] via-[#d946ef] to-[#ec4899] bg-clip-text text-transparent inline-flex items-center whitespace-nowrap mt-4">
    ...
    <img
      ...
      className="w-12 h-12 ml-2 wave-emoji"
    />
  </span>
</h1>
        ...
        <p className="text-lg sm:text-xl font-thin text-gray-300 mt-4">
          A passionate Software Developer who loves coding and building
          impactful solutions.
        </p>
  ...
  {socialLinks.map((link, index) => (
    ...
    >
      ...
      <div className="w-1/3 flex items-center justify-start mt-6 md:mt-0">
      <img
