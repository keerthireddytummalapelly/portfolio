    ...
    return (
      <div className="flex flex-col md:flex-row items-center justify-between min-h-screen bg-transparent px-4">
        ...
        <div className="md:w-1/2 flex flex-col justify-center items-start text-left">
          {/* Heading */}
          <h2 className="text-5xl font-thin mb-4 text-white">
            Let's Connect!!
          </h2>
    
          {/* Intro Text */}
          <p className="text-lg text-gray-300 mb-8 max-w-xl">
          Let’s collaborate on a project, say hello on Gmail or LinkedIn, or check out my work on GitHub and LeetCode.
          </p>
